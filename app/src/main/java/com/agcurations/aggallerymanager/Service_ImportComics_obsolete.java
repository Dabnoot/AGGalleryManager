...
public class Service_ImportComics_obsolete extends IntentService {
    ...
    public Service_ImportComics_obsolete() {
    ...
    public void BroadcastProgress(boolean bUpdateLog, String sLogLine,
        ...
        broadcastIntent.setAction(Activity_ImportComics_obsolete.ImportResponseReceiver.IMPORT_ACTION_RESPONSE);
