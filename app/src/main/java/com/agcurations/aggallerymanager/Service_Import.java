...
public class Service_Import extends IntentService {
    ...
    private void handleAction_startActionVideoAnalyzeHTML(){
        ...
        BroadcastProgress(true, "Textual searches complete. Parsing HTML...",
                false, 0,
                false, "",
                sIntentActionFilter);
        ...
        for (ItemClass_VideoDownloadSearchKey vdsk : icWebDataLocator.alVideoDownloadSearchKeys){
            ...
            switch (vdsk.sDataType) {
                ...
                case VIDEO_DOWNLOAD_THUMBNAIL:
                    ...
                    if (vdsk.bMatchFound) {
                        sURLThumbnail = cleanHTMLCodedCharacters(vdsk.sSearchStringMatchContent); //Convert any html coded characters
                ...
                case VIDEO_DOWNLOAD_M3U8:
                    ...
                    try {
                        ...
                        */
                        ...
                        problemNotificationConfig(vdsk.sErrorMessage, sIntentActionFilter);
                    }
                    break;
            }
