...
public class ImportFragment_5_Confirmation extends Fragment {
    ...
    public void initComponents(){
        ...
        confirmationFileListCustomAdapter = new ConfirmationFileListCustomAdapter(getActivity(), R.id.listView_FilesToImport, importActivityViewModel.alfiConfirmedFileImports);
    ...
    public class ConfirmationFileListCustomAdapter extends ArrayAdapter<FileItem> {

        final public ArrayList<FileItem> alFileItems;

        public ConfirmationFileListCustomAdapter(@NonNull Context context, int resource, ArrayList<FileItem> alfi) {
