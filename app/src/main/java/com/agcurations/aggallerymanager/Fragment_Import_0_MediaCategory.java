...
public class Fragment_Import_0_MediaCategory extends Fragment {
    ...
    public static Fragment_Import_0_MediaCategory newInstance(String param1, String param2) {
        Fragment_Import_0_MediaCategory fragment = new Fragment_Import_0_MediaCategory();
