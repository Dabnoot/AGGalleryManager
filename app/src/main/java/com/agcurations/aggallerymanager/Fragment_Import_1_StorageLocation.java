...
public class Fragment_Import_1_StorageLocation extends Fragment {
    ...
    public static Fragment_Import_1_StorageLocation newInstance(String param1, String param2) {
        Fragment_Import_1_StorageLocation fragment = new Fragment_Import_1_StorageLocation();
